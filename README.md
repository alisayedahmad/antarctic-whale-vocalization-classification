...
Pipeline
Spectrogram Generation: Audio files are transformed into spectrograms using Short-Time Fourier Transform (STFT)
...
Image Extraction: Vocalizations are extracted as image patches from spectrograms based on annotation coordinates (time-frequency bounding boxes)

Feature Engineering: Multiple feature sets extracted including statistical, spectral, and temporal features

Classification: Trained models predict the vocalization class from input spectrograms

Evaluation: Performance measured using precision, recall, F1-score, and confusion matrices
