...
- **Low frequency vocalizations**: Calls are below 120 Hz, mostly inaudible to humans
- **Temporal and spectral overlap**: Multiple call types can overlap in time and frequency
- **Variable image sizes**: Extracted spectrograms have different dimensions
- **Class imbalance**: Some call types are more prevalent than others
- **Ambiguous calls**: Certain vocalizations are difficult to differentiate (e.g., BmD vs BpD)
